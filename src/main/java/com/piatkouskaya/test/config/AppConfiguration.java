package com.piatkouskaya.test.config;
...
@EnableJpaRepositories(basePackages = "com.piatkouskaya.test.db")
@ComponentScan(basePackages = "com.piatkouskaya.test.service")
public class AppConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource,
        ...
        factory.setPackagesToScan("com.piatkouskaya.test.entity");
